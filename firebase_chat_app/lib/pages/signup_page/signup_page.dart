...
import 'package:firebase_chat_app/extensions.dart';
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    User? user = await AuthService.authService
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    ...
                    onPressed: () {},
                    icon: Icon(FontAwesomeIcons.squareXTwitter),
                    label: const Text(
                      "Twitter",
                      style: TextStyle(
                        fontFamily: 'realNova',
              ...
              ElevatedButton.icon(
                ...
                onPressed: () async {
                  User? user = await AuthService.authService.anonymousLogin();
                  if (user != null) {
                    Navigator.of(context)
                        .pushReplacementNamed(AppRoutes.instance.todoPage);
                  } else {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text("Failed !!"),
              ...
              Row(
                ...
                children: [
                  const Text(
                    ...
                    style: TextStyle(fontFamily: 'realNova', fontSize: 15),
                  ),
                  GestureDetector(
                    onTap: () {
                    ...
                    child: const Text(
                      " Login",
                      style: TextStyle(
                          fontFamily: 'realNova', fontWeight: FontWeight.bold),
                    ),
                  )
                ],
              )
